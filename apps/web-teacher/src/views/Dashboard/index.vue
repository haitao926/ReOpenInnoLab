          ...
          <div class="sidebar-activity-list">
            ...
            >
              ...
              <div class="sidebar-activity-content">
                <div class="sidebar-activity-text">
          ...
          <div class="insight-grid">
            ...
            >
              <div class="student-status">
                <div
                  v-for="status in studentHighlights"
                  :key="status.id"
                  class="student-status__item"
                >
                  <span
                    class="student-status__icon"
                    :class="`student-status__icon--${status.tone}`"
                  >
          ...
          <div class="insight-grid">
                  ...
                  <div class="alert-content">
                    ...
                    <div class="alert-meta">
                      ...
                      <span class="alert-count">
                        {{ alert.submittedCount }}/{{ alert.totalCount }} 已提交
                      </span>
                    </div>
                  </div>
            ...
            >
              <div class="assignment-analysis">
                <div
                  v-for="analysis in assignmentAnalysis"
                  :key="analysis.id"
                  class="analysis-item"
                >
                ...
                <div v-for="insight in learningInsights" :key="insight.id" class="insight-item">
                  ...
                  <div class="insight-actions">
                    <el-button
                      type="text"
                      size="small"
                      @click="handleInsightAction(insight, 'view')"
                    >
                      查看详情
                    </el-button>
                    <el-button
                      type="text"
                      size="small"
                      @click="handleInsightAction(insight, 'intervene')"
                    >
                      个性化辅导
                    </el-button>
                  </div>
...
<script setup lang="ts">
  ...
  const baseAiObservationReports = ref([
    {
      id: 'report-1',
      text: 'AI 创意编程班项目达成率提升 6%，建议扩展跨学科案例。',
      type: '积极变化',
      icon: TrendCharts,
      subject: 'ai'
    },
    {
      id: 'report-2',
      text: 'AI 数据洞察实验提交率低于 80%，建议推送分步引导。',
      type: '改进建议',
      icon: Warning,
      subject: 'ai'
    },
    {
      id: 'report-3',
      text: 'AI 视觉项目学生满意度 96%，适合安排公开课展示。',
      type: '正面评价',
      icon: Star,
      subject: 'ai'
    }
