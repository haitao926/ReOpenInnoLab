<template>
  ...
  >
    ...
    >
      <svg class="app-sidebar__toggle-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <ul class="app-sidebar__nav-list">
        ...
        >
          ...
          >
            <button
              type="button"
              class="app-sidebar__nav-group-btn"
            ...
            <transition name="sidebar-slide">
              <ul v-if="!collapsed && expandedItems.includes(item.key)" class="app-sidebar__nav-sublist">
                <li
